...
export FZF_DEFAULT_COMMAND='rg --files --no-ignore --hidden --follow -g "!{.git,frontend,frontend/node_modules,node_modules,Library,.gnupg,swagger,.config/yarn,tmp}/*" -g "!*.log" -g "!tags" 2> /dev/null'
